                    ...
                    if st.button("✅ 出餐", type="primary", use_container_width=True):
                        ...
                        if disabled_item_detected:
                            ...
                            try:
                                ...
                                # 精準清除今日訂單與歷史記錄快取，其餘首頁庫存快取維持不變，不卡前台
...
# ============================================================================
# 頁籤 2：修改當日出餐數量 (導入 Fragment 局部刷新)
# ============================================================================
with pos_tabs[1]:
    @st.fragment
...
with pos_tabs[2]:
    ...
    render_dish_recipe_modification_zone()


# ============================================================================
# 頁籤 4：品項下架與管理區 (導入 Fragment 局部刷新)
# ============================================================================
with pos_tabs[3]:
    @st.fragment
    ...
    render_item_management_and_disable_zone()